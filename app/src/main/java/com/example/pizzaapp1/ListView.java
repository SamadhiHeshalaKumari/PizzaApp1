...
public class ListView extends AppCompatActivity implements PizzaAdapter.OnItemClickListner {
    ...
    private static final String URL_DATA = "http://192.168.1.129:8080/demo/all";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i =0; i<products.length(); i++){
                        ...
                        String imgUrl = productobject.getString("imgUrl");

                        Pizza product = new Pizza(id, name, description, price,imgUrl);
